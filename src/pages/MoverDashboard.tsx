          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <button onClick={() => navigate('/mover/movings')} className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-xl p-5 hover:from-cyan-600 hover:to-cyan-700 transition shadow-md text-left group">
                  <div className="flex items-center justify-between"><div><h3 className="text-lg font-bold mb-1">Suivi missions</h3><p className="text-cyan-100 text-sm">Voir les déménagements</p></div><ChevronRight className="w-6 h-6 group-hover:translate-x-1 transition-transform" /></div>
                </button>
              </div>
            </div>
                ...
                {recentQuotes.map((quote) => (
                  <div key={quote.id} className="flex items-center justify-between py-3 border-b border-gray-50 last:border-0">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-bold text-gray-900">{quote.total_price?.toFixed(0) || '—'} €</p>
